...
export default function DashboardCard({ icon, title, description }: DashboardCardProps) {
  return (
    <div className="w-full h-auto md:h-[285px] bg-white border-2 border-schedsync-gray-4 rounded-[20px] md:rounded-[30px] p-4 md:p-6 flex flex-col md:flex-row transition-transform transform hover:-translate-y-1 hover:scale-[1.01] hover:shadow-lg hover:border-slate-300 cursor-pointer">
      {/* Icon */}
