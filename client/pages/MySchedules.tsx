...
function ScheduleItem({ name, updated, created, isPublished }: ScheduleItemProps) {
  return (
...
export default function MySchedules() {
  const publishedSchedules = [
    { name: "Schedule Name", updated: "(date)", created: "(date)", isPublished: true }
  ];

  const draftSchedules = [
    { name: "Schedule Name", updated: "(date)", created: "(date)", isPublished: false },
    { name: "Schedule Name", updated: "(date)", created: "(date)", isPublished: false },
    { name: "Schedule Name", updated: "(date)", created: "(date)", isPublished: false }
  ];
